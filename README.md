...
11. Перед реєстрацією реєстру в Реєстрі реєстрів створювач перевіряє наявність зареєстрованої інформаційно-комунікаційної системи, яка забезпечує функціонування реєстру. У разі відсутності зареєстрованої інформаційної системи, яка забезпечує функціонування реєстру, створювач вчиняє дії для реєстрації такої інформаційно-комунікаційної системи.
...
14. Для реєстрації реєстру створювач створює в електронному кабінеті засобами Реєстру реєстрів заяву про реєстрацію реєстру в Реєстрі реєстрів.
15. Заява про реєстрацію реєстру в Реєстрі реєстрів містить:
1) назву реєстру;
...
13) ідентифікатор інформаційно-комунікаційної системи, зареєстрованої у Реєстрі реєстрів, що забезпечує ведення реєстру.
...
17. Для реєстрації реєстру, інформаційно-комунікаційна система якого ще не створена, створювач створює в особистому електронному кабінеті засобами Реєстру реєстрів заяву про реєстрацію реєстру, інформаційна система якого ще не створена, в Реєстрі реєстрів.
...
3) ідентифікатор зареєстрованого реєстру в Реєстрі реєстрів (за наявності);
...
30. Реєстрація припинення реєстру здійснюється в порядку внесення змін до інформації про реєстр, шляхом створення та подання заяви про реєстрацію змін щодо реєстру в Реєстрі реєстрів у строки, визначені пунктом 48 цього Порядку.
...
38. Реєстровий номер об’єкта Реєстру реєстрів залишається незмінним протягом усього часу існування такого об’єкта.
...
Обов’язки держателів реєстрів та строки подання держателями реєстрів інформації до Реєстру реєстрів 
...
4) забезпечує створення та/або встановлення оновлення програмного забезпечення Реєстру реєстрів;
...
2) проводить технічні і технологічні заходи для забезпечення роботи Реєстру реєстрів, забезпечення хостингу, обслуговування технічного комплексу реєстру;
...
56. Заява про надання доступу подається через електронний кабінет або надсилається службовим листом за підписом керівника держателя реєстру або особи, яка може вчиняти дії від імені юридичної особи, адміністратору Реєстру реєстрів. 
...
2) адміністратором Реєстру реєстрів на підставі службового листа держателя реєстру.
